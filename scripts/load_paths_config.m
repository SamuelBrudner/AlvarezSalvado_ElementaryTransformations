...
%   falling back to ``paths.yaml`` for backward compatibility. Expands any
%   environment variables and returns a struct with the configuration values.
    ...
    if ~exist(configFile, 'file')
        % Fallback for legacy paths.yaml
